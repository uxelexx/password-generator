...
export default function Password({ password }: PasswordProps) {
  ...
  return (
    <div className="text-neutral-100 relative p-6 bg-zinc-700/80 w-full flex justify-between items-center">
      <span
        ref={ref}
      ...
      <button
        type="button"
        className="cursor-pointer text-neutral-100 text-opacity-70 hover:text-opacity-100 active:scale-95"
        onClick={handleCopy}
      >
        <CopyIcon />
      </button>
